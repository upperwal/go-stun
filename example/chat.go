...
var bootstrapPeers = []string{
	...
	"/ip4/13.89.40.122/udp/4000/quic/p2p/QmVbcMycaK8ni5CeiM7JRjBRAdmwky6dQ6KcoxLesZDPk9", // might be offline
}

var stunServer = "/ip4/13.89.40.122/udp/3000/" // might be offline
...
func main() {
	...
	for _, p := range peers {
		...
		for _, addr := range p.Addrs {
			if strings.Contains(addr.String(), "p2p-circuit") || strings.Contains(addr.String(), "127.0") || strings.Contains(addr.String(), "192.168") {
				continue
			} else {
				raddr = addr
			}
